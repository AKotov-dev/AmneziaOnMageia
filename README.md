...
`AmneziaVPN` has been tested in [MgaRemix-Proserpina](https://github.com/AKotov-dev/MgaRemix-Proserpina) (NetworkManager/nm-applet) & Mageia-9-MATE (network/net_applet).
